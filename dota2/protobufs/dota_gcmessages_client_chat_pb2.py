...
_CMSGDOTACHATMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='requested_ability_id', full_name='dota.CMsgDOTAChatMessage.requested_ability_id', index=32,
