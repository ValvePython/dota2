...
_CMSGDOTAMATCH_PLAYER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rank_tier', full_name='dota.CMsgDOTAMatch.Player.rank_tier', index=18,
