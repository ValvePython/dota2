...
_CSODOTAGAMEACCOUNTCLIENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='coach_rating', full_name='dota.CSODOTAGameAccountClient.coach_rating', index=71,
