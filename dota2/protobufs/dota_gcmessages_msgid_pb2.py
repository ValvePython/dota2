...
_EDOTAGCMSG = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgAnchorPhoneNumberRequest', index=690, number=8222,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgAnchorPhoneNumberResponse', index=691, number=8223,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgUnanchorPhoneNumberRequest', index=692, number=8224,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='k_EMsgUnanchorPhoneNumberResponse', index=693, number=8225,
      options=None,
      type=None),
  ],
