...
_EEVENT = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVENT_ID_COUNT', index=20, number=20,
      options=None,
      type=None),
  ],
  containing_type=None,
