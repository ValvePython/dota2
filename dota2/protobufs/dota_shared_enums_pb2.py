...
_EEVENT = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EVENT_ID_COUNT', index=15, number=15,
      options=None,
      type=None),
  ],
  containing_type=None,
