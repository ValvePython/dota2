...
_CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE_ESUBSCRIPTIONSTATE = _descriptor.EnumDescriptor(
  name='ESubscriptionState',
  full_name='dota.CMsgGCCheckAccountSubscriptionResponse.ESubscriptionState',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_sym_db.RegisterEnumDescriptor(_CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE_ESUBSCRIPTIONSTATE)
...
_CMSGGCCHECKACCOUNTSUBSCRIPTION = _descriptor.Descriptor(
  name='CMsgGCCheckAccountSubscription',
  full_name='dota.CMsgGCCheckAccountSubscription',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='account_id', full_name='dota.CMsgGCCheckAccountSubscription.account_id', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='def_index', full_name='dota.CMsgGCCheckAccountSubscription.def_index', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE = _descriptor.Descriptor(
  name='CMsgGCCheckAccountSubscriptionResponse',
  full_name='dota.CMsgGCCheckAccountSubscriptionResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='dota.CMsgGCCheckAccountSubscriptionResponse.state', index=0,
      number=1, type=14, cpp_type=8, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cache_until', full_name='dota.CMsgGCCheckAccountSubscriptionResponse.cache_until', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[],
  enum_types=[
    _CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE_ESUBSCRIPTIONSTATE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto2',
...
_CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE.fields_by_name['state'].enum_type = _CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE_ESUBSCRIPTIONSTATE
_CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE_ESUBSCRIPTIONSTATE.containing_type = _CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE
...
CMsgGCCheckAccountSubscription = _reflection.GeneratedProtocolMessageType('CMsgGCCheckAccountSubscription', (_message.Message,), dict(
  DESCRIPTOR = _CMSGGCCHECKACCOUNTSUBSCRIPTION,
  __module__ = 'econ_gcmessages_pb2'
  # @@protoc_insertion_point(class_scope:dota.CMsgGCCheckAccountSubscription)
  ))
_sym_db.RegisterMessage(CMsgGCCheckAccountSubscription)

CMsgGCCheckAccountSubscriptionResponse = _reflection.GeneratedProtocolMessageType('CMsgGCCheckAccountSubscriptionResponse', (_message.Message,), dict(
  DESCRIPTOR = _CMSGGCCHECKACCOUNTSUBSCRIPTIONRESPONSE,
  __module__ = 'econ_gcmessages_pb2'
